...
Target_Prediction_Data[[1]] <- read.csv("./App_Data/Energy_Tables/EF_Energy.csv")
Target_Prediction_Data[[2]] <- read.csv("./App_Data/Energy_Tables/SA_Energy.csv")
Target_Prediction_Data[[3]] <- read.csv("./App_Data/Energy_Tables/KP_Energy.csv")
Target_Prediction_Data[[4]] <- read.csv("./App_Data/Energy_Tables/AB_Energy.csv")
Target_Prediction_Data[[5]] <- read.csv("./App_Data/Energy_Tables/PA_Energy.csv")
Target_Prediction_Data[[6]] <- read.csv("./App_Data/Energy_Tables/EC_Energy.csv")
...

{
  #E. faecium
  {
    ...
    write.csv(Target_Prediction_Data[[1]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/EFGeneIDs.csv")
  }
  
  #S. aureus
  {
    Target_Prediction_Data[[2]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[2]]), "GeneID:\\s*[0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[2]]$Gene_ID)) {
        Target_Prediction_Data[[2]]$Gene_ID[i] <- substr(Target_Prediction_Data[[2]]$Gene_ID[i], 8, nchar(Target_Prediction_Data[[2]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[2]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/SAGeneIDs.csv")
  }
  ...
  #K. pneumoniae
  {
    ...
    write.csv(Target_Prediction_Data[[3]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/KPGeneIDs.csv")
  }
  ...
  #A. baumannii
  {
    ...
    write.csv(Target_Prediction_Data[[4]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/ABGeneIDs.csv")
  }
  
  #P. aeruginosa
  {
    Target_Prediction_Data[[5]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[5]]), "GeneID:\\s*[0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[5]]$Gene_ID)) {
        Target_Prediction_Data[[5]]$Gene_ID[i] <- substr(Target_Prediction_Data[[5]]$Gene_ID[i], 8, nchar(Target_Prediction_Data[[5]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[5]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/PAGeneIDs.csv")
  }
  ...
  #E. cloacae
  {
    ...
    write.csv(Target_Prediction_Data[[6]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/ECGeneIDs.csv")
  }
...
{
Gene_Annotation_Data[[1]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/EF_Annotations.csv")
Gene_Annotation_Data[[2]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/SA_Annotations.csv")
Gene_Annotation_Data[[3]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/KP_Annotations.csv")
Gene_Annotation_Data[[4]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/AB_Annotations.csv")
Gene_Annotation_Data[[5]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/PA_Annotations.csv")
Gene_Annotation_Data[[6]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/EC_Annotations.csv")

Gene_Annotation_Data[[1]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/EF_Conversion.csv")
Gene_Annotation_Data[[2]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/SA_Conversion.csv")
Gene_Annotation_Data[[3]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/KP_Conversion.csv")
Gene_Annotation_Data[[4]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/AB_Conversion.csv")
Gene_Annotation_Data[[5]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/PA_Conversion.csv")
Gene_Annotation_Data[[6]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/EC_Conversion.csv")
...
KEGG_Gene_Lists[[1]] <- getGenesets(org = "efu", db = "kegg")
KEGG_Gene_Lists[[2]] <- getGenesets(org = "sao", db = "kegg")
KEGG_Gene_Lists[[3]] <- getGenesets(org = "kpn", db = "kegg")
KEGG_Gene_Lists[[4]] <- getGenesets(org = "aby", db = "kegg")
KEGG_Gene_Lists[[5]] <- getGenesets(org = "pae", db = "kegg")
KEGG_Gene_Lists[[6]] <- getGenesets(org = "ecln", db = "kegg")
...
for (j in 1:length(KEGG_Gene_Lists[[2]])) {
    KEGG_Pathway_List[[2]][[j]] <- KEGG_Pathway_Data[[2]][KEGG_Pathway_Data[[2]]$Gene_ID %in% KEGG_Gene_Lists[[2]][[j]],]
}
...
for (j in 1:length(KEGG_Gene_Lists[[5]])) {
    KEGG_Pathway_List[[5]][[j]] <- KEGG_Pathway_Data[[5]][KEGG_Pathway_Data[[5]]$Gene_ID %in% KEGG_Gene_Lists[[5]][[j]],]
}


for (i in 1:nrow(KEGG_Pathway_Data[[6]])) {
  KEGG_Pathway_Data[[6]]$KEGG_ID[i] <- substr(KEGG_Pathway_Data[[6]]$KEGG_ID[i], 6, nchar(KEGG_Pathway_Data[[6]]$KEGG_ID[i]))
}
...
#Target_Cutoff_List_Copy_1_17_23 <- Target_Cutoff_List
