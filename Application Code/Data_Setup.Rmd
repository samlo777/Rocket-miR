...
# Goal: Convert target predictions and annotation data into .Rdata objects that work with the application code
...
Target_Prediction_Data[[1]] <- read.csv("./App_Data/Energy_Tables/AX_Energy.csv")
Target_Prediction_Data[[2]] <- read.csv("./App_Data/Energy_Tables/AB_Energy.csv")
Target_Prediction_Data[[3]] <- read.csv("./App_Data/Energy_Tables/AF_Energy.csv")
Target_Prediction_Data[[4]] <- read.csv("./App_Data/Energy_Tables/BF_Energy.csv")
Target_Prediction_Data[[5]] <- read.csv("./App_Data/Energy_Tables/BC_Energy.csv")
Target_Prediction_Data[[6]] <- read.csv("./App_Data/Energy_Tables/BM_Energy.csv")
Target_Prediction_Data[[7]] <- read.csv("./App_Data/Energy_Tables/CA_Energy.csv")
Target_Prediction_Data[[8]] <- read.csv("./App_Data/Energy_Tables/CD_Energy.csv")
Target_Prediction_Data[[9]] <- read.csv("./App_Data/Energy_Tables/CP_Energy.csv")
Target_Prediction_Data[[10]] <- read.csv("./App_Data/Energy_Tables/EC1_Energy.csv")
Target_Prediction_Data[[11]] <- read.csv("./App_Data/Energy_Tables/EF_Energy.csv")
Target_Prediction_Data[[12]] <- read.csv("./App_Data/Energy_Tables/EC_Energy.csv")
Target_Prediction_Data[[13]] <- read.csv("./App_Data/Energy_Tables/HI_Energy.csv")
Target_Prediction_Data[[14]] <- read.csv("./App_Data/Energy_Tables/KP_Energy.csv")
Target_Prediction_Data[[15]] <- read.csv("./App_Data/Energy_Tables/MA_Energy.csv")
Target_Prediction_Data[[16]] <- read.csv("./App_Data/Energy_Tables/MAv_Energy.csv")
Target_Prediction_Data[[17]] <- read.csv("./App_Data/Energy_Tables/PM_Energy.csv")
Target_Prediction_Data[[18]] <- read.csv("./App_Data/Energy_Tables/PA_Energy.csv")
Target_Prediction_Data[[19]] <- read.csv("./App_Data/Energy_Tables/SA_Energy.csv")
Target_Prediction_Data[[20]] <- read.csv("./App_Data/Energy_Tables/SM_Energy.csv")
Target_Prediction_Data[[21]] <- read.csv("./App_Data/Energy_Tables/SP2_Energy.csv")
Target_Prediction_Data[[22]] <- read.csv("./App_Data/Energy_Tables/SP_Energy.csv")
Target_Prediction_Data[[23]] <- read.csv("./App_Data/Energy_Tables/SS2_Energy.csv")
Target_Prediction_Data[[24]] <- read.csv("./App_Data/Energy_Tables/SS_Energy.csv")
...
#First need to take the gene identifier column for each IntaRNA data table, and use RegExp to extract out just the ID that we want to map to KEGG IDs. The NCBI Gene ID is what we will use for the initial mapping. And if the gene ID is not in the data, use the protein ID.

{
  #A. xylosoxidans
  {
    Target_Prediction_Data[[1]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[1]]), "protein_id=\\s*[WP_.0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[1]]$Gene_ID)) {
        Target_Prediction_Data[[1]]$Gene_ID[i] <- substr(Target_Prediction_Data[[1]]$Gene_ID[i], 12, nchar(Target_Prediction_Data[[1]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[1]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/AXGeneIDs.csv")
  }
  ...
  #A. baumannii
  {
    ...
    write.csv(Target_Prediction_Data[[2]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/ABGeneIDs.csv")
  }
  
  #A. fumigatus
  {
    Target_Prediction_Data[[3]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[3]]), "GeneID:\\s*[0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[3]]$Gene_ID)) {
        Target_Prediction_Data[[3]]$Gene_ID[i] <- substr(Target_Prediction_Data[[3]]$Gene_ID[i], 8, nchar(Target_Prediction_Data[[3]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[3]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/AFGeneIDs.csv")
  }
  
  #B. fragilis
  {
    Target_Prediction_Data[[4]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[4]]), "protein_id=\\s*[WP_.0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[4]]$Gene_ID)) {
        Target_Prediction_Data[[4]]$Gene_ID[i] <- substr(Target_Prediction_Data[[4]]$Gene_ID[i], 12, nchar(Target_Prediction_Data[[4]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[4]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/BFGeneIDs.csv")
  }
  ...
  #B. cenocepacia
  {
    ...
    write.csv(Target_Prediction_Data[[5]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/BCGeneIDs.csv")
  }
  ...
  #B. multivorans
  {
    ...
    write.csv(Target_Prediction_Data[[6]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/BMGeneIDs.csv")
  }
  
  #C. albicans
  {
    Target_Prediction_Data[[7]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[7]]), "GeneID:\\s*[0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[7]]$Gene_ID)) {
        Target_Prediction_Data[[7]]$Gene_ID[i] <- substr(Target_Prediction_Data[[7]]$Gene_ID[i], 8, nchar(Target_Prediction_Data[[7]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[7]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/CAGeneIDs.csv")
  }
  ...
  #C. difficile
  {
    ...
    write.csv(Target_Prediction_Data[[8]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/CDGeneIDs.csv")
  }
  ...
  #C. perfringens
  {
    ...
    write.csv(Target_Prediction_Data[[9]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/CPGeneIDs.csv")
  }
  
  #E. cloacae
  {
    Target_Prediction_Data[[10]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[10]]), "protein_id=\\s*[WP_.0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[10]]$Gene_ID)) {
        Target_Prediction_Data[[10]]$Gene_ID[i] <- substr(Target_Prediction_Data[[10]]$Gene_ID[i], 12, nchar(Target_Prediction_Data[[10]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[10]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/ECGeneIDs.csv")
  }
  
  #E. faecium
  {
    Target_Prediction_Data[[11]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[11]]), "protein_id=\\s*[WP_.0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[11]]$Gene_ID)) {
        Target_Prediction_Data[[11]]$Gene_ID[i] <- substr(Target_Prediction_Data[[11]]$Gene_ID[i], 12, nchar(Target_Prediction_Data[[11]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[11]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/EFGeneIDs.csv")
  }
  
  #E. coli
  {
    Target_Prediction_Data[[12]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[12]]), "protein_id=\\s*[WNYP_.0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[12]]$Gene_ID)) {
        Target_Prediction_Data[[12]]$Gene_ID[i] <- substr(Target_Prediction_Data[[12]]$Gene_ID[i], 12, nchar(Target_Prediction_Data[[12]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[12]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/ECGeneIDs.csv")
  }
  ...
  #H. influenza
  {
    ...
    write.csv(Target_Prediction_Data[[13]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/HIGeneIDs.csv")
  }
  ...
  #K. pneumoniae
  {
    ...
    write.csv(Target_Prediction_Data[[14]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/KPGeneIDs.csv")
  }
  ...
  #M. abscessus
  {
    ...
    write.csv(Target_Prediction_Data[[15]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/MAGeneIDs.csv")
  }
  ...
  #M. avium
  {
    ...
    write.csv(Target_Prediction_Data[[16]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/MAvGeneIDs.csv")
  }

  #P. melaninogenica
  {
    Target_Prediction_Data[[17]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[17]]), "GeneID:\\s*[0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[17]]$Gene_ID)) {
        Target_Prediction_Data[[17]]$Gene_ID[i] <- substr(Target_Prediction_Data[[17]]$Gene_ID[i], 8, nchar(Target_Prediction_Data[[17]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[17]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/PMGeneIDs.csv")
  }
  
  #P. aeruginosa
  {
    Target_Prediction_Data[[18]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[18]]), "GeneID:\\s*[0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[18]]$Gene_ID)) {
        Target_Prediction_Data[[18]]$Gene_ID[i] <- substr(Target_Prediction_Data[[18]]$Gene_ID[i], 8, nchar(Target_Prediction_Data[[18]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[18]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/PAGeneIDs.csv")
  }
  
  #S. aureus
  {
    Target_Prediction_Data[[19]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[19]]), "GeneID:\\s*[0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[19]]$Gene_ID)) {
        Target_Prediction_Data[[19]]$Gene_ID[i] <- substr(Target_Prediction_Data[[19]]$Gene_ID[i], 8, nchar(Target_Prediction_Data[[19]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[19]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/SAGeneIDs.csv")
  }
  ...
  #S. maltophilia
  {
    ...
    write.csv(Target_Prediction_Data[[20]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/SMGeneIDs.csv")
  }
  
  #S. parasanguinis
  {
    Target_Prediction_Data[[21]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[21]]), "protein_id=\\s*[WP_.0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[21]]$Gene_ID)) {
        Target_Prediction_Data[[21]]$Gene_ID[i] <- substr(Target_Prediction_Data[[21]]$Gene_ID[i], 12, nchar(Target_Prediction_Data[[21]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[21]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/SPaGeneIDs.csv")
  }
  
  #S. pneumonia
  {
    Target_Prediction_Data[[22]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[22]]), "protein_id=\\s*[WP_.0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[22]]$Gene_ID)) {
        Target_Prediction_Data[[22]]$Gene_ID[i] <- substr(Target_Prediction_Data[[22]]$Gene_ID[i], 12, nchar(Target_Prediction_Data[[22]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[22]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/SPGeneIDs.csv")
  }
  
  #S. salivarius
  {
    Target_Prediction_Data[[23]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[23]]), "protein_id=\\s*[WP_.0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[23]]$Gene_ID)) {
        Target_Prediction_Data[[23]]$Gene_ID[i] <- substr(Target_Prediction_Data[[23]]$Gene_ID[i], 12, nchar(Target_Prediction_Data[[23]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[23]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/SSalGeneIDs.csv")
  }
  
  #S. sanguinis
  {
    Target_Prediction_Data[[24]]$Gene_ID <- unlist(str_extract(rownames(Target_Prediction_Data[[24]]), "protein_id=\\s*[WP_.0-9]+\\s*"))
    for (i in 1:length(Target_Prediction_Data[[24]]$Gene_ID)) {
        Target_Prediction_Data[[24]]$Gene_ID[i] <- substr(Target_Prediction_Data[[24]]$Gene_ID[i], 12, nchar(Target_Prediction_Data[[24]]$Gene_ID[i]))
    } 
    write.csv(Target_Prediction_Data[[24]]$Gene_ID, "./App_Data/Annotation_Data/Gene_IDs/SSGeneIDs.csv")
  }
...
{
Gene_Annotation_Data[[1]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/AX_Annotations.csv")
Gene_Annotation_Data[[2]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/AB_Annotations.csv")
Gene_Annotation_Data[[3]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/AF_Annotations.csv")
Gene_Annotation_Data[[4]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/BF_Annotations.csv")
Gene_Annotation_Data[[5]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/BC_Annotations.csv")
Gene_Annotation_Data[[6]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/BM_Annotations.csv")
Gene_Annotation_Data[[7]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/CA_Annotations.csv")
Gene_Annotation_Data[[8]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/CD_Annotations.csv")
Gene_Annotation_Data[[9]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/CP_Annotations.csv")
Gene_Annotation_Data[[10]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/EC1_Annotations.csv")
Gene_Annotation_Data[[11]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/EF_Annotations.csv")
Gene_Annotation_Data[[12]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/EC_Annotations.csv")
Gene_Annotation_Data[[13]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/HI_Annotations.csv")
Gene_Annotation_Data[[14]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/KP_Annotations.csv")
Gene_Annotation_Data[[15]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/MA_Annotations.csv")
Gene_Annotation_Data[[16]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/MAv_Annotations.csv")
Gene_Annotation_Data[[17]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/PM_Annotations.csv")
Gene_Annotation_Data[[18]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/PA_Annotations.csv")
Gene_Annotation_Data[[19]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/SA_Annotations.csv")
Gene_Annotation_Data[[20]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/SM_Annotations.csv")
Gene_Annotation_Data[[21]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/SPa_Annotations.csv")
Gene_Annotation_Data[[22]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/SP_Annotations.csv")
Gene_Annotation_Data[[23]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/SSal_Annotations.csv")
Gene_Annotation_Data[[24]][[1]] <- read.csv("./App_Data/Annotation_Data/Annotation_Tables/SS_Annotations.csv")

Gene_Annotation_Data[[1]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/AX_Conversion.csv")
Gene_Annotation_Data[[2]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/AB_Conversion.csv")
Gene_Annotation_Data[[3]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/AF_Conversion.csv")
Gene_Annotation_Data[[4]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/BF_Conversion.csv")
Gene_Annotation_Data[[5]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/BC_Conversion.csv")
Gene_Annotation_Data[[6]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/BM_Conversion.csv")
Gene_Annotation_Data[[7]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/CA_Conversion.csv")
Gene_Annotation_Data[[8]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/CD_Conversion.csv")
Gene_Annotation_Data[[9]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/CP_Conversion.csv")
Gene_Annotation_Data[[10]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/EC1_Conversion.csv")
Gene_Annotation_Data[[11]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/EF_Conversion.csv")
Gene_Annotation_Data[[12]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/EC_Conversion.csv")
Gene_Annotation_Data[[13]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/HI_Conversion.csv")
Gene_Annotation_Data[[14]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/KP_Conversion.csv")
Gene_Annotation_Data[[15]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/MA_Conversion.csv")
Gene_Annotation_Data[[16]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/MAv_Conversion.csv")
Gene_Annotation_Data[[17]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/PM_Conversion.csv")
Gene_Annotation_Data[[18]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/PA_Conversion.csv")
Gene_Annotation_Data[[19]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/SA_Conversion.csv")
Gene_Annotation_Data[[20]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/SM_Conversion.csv")
Gene_Annotation_Data[[21]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/SPa_Conversion.csv")
Gene_Annotation_Data[[22]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/SP_Conversion.csv")
Gene_Annotation_Data[[23]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/SSal_Conversion.csv")
Gene_Annotation_Data[[24]][[2]] <- read.csv("./App_Data/Annotation_Data/Uniprot_Conversion/SS_Conversion.csv")
...
Gene_Annotation_Data[[21]][[2]] <- Gene_Annotation_Data[[21]][[2]][,c(1:2)]
Gene_Annotation_Data[[22]][[2]] <- Gene_Annotation_Data[[22]][[2]][,c(1:2)]
Gene_Annotation_Data[[23]][[2]] <- Gene_Annotation_Data[[23]][[2]][,c(1:2)]
Gene_Annotation_Data[[24]][[2]] <- Gene_Annotation_Data[[24]][[2]][,c(1:2)]
...
Gene_Annotation_Data[[21]][[3]] <- merge(Gene_Annotation_Data[[21]][[1]], Gene_Annotation_Data[[21]][[2]], by = "Uniprot_ID", all = TRUE)
Gene_Annotation_Data[[22]][[3]] <- merge(Gene_Annotation_Data[[22]][[1]], Gene_Annotation_Data[[22]][[2]], by = "Uniprot_ID", all = TRUE)
Gene_Annotation_Data[[23]][[3]] <- merge(Gene_Annotation_Data[[23]][[1]], Gene_Annotation_Data[[23]][[2]], by = "Uniprot_ID", all = TRUE)
Gene_Annotation_Data[[24]][[3]] <- merge(Gene_Annotation_Data[[24]][[1]], Gene_Annotation_Data[[24]][[2]], by = "Uniprot_ID", all = TRUE)
...
KEGG_Gene_Lists[[1]] <- getGenesets(org = "axy", db = "kegg")
KEGG_Gene_Lists[[2]] <- getGenesets(org = "aby", db = "kegg")
KEGG_Gene_Lists[[3]] <- getGenesets(org = "afm", db = "kegg")
KEGG_Gene_Lists[[4]] <- getGenesets(org = "bfs", db = "kegg")
KEGG_Gene_Lists[[5]] <- getGenesets(org = "bcj", db = "kegg")
KEGG_Gene_Lists[[6]] <- getGenesets(org = "bmj", db = "kegg")
KEGG_Gene_Lists[[7]] <- getGenesets(org = "cal", db = "kegg")
KEGG_Gene_Lists[[8]] <- getGenesets(org = "cdf", db = "kegg")
KEGG_Gene_Lists[[9]] <- getGenesets(org = "cpf", db = "kegg")
KEGG_Gene_Lists[[10]] <- getGenesets(org = "ecln", db = "kegg")
KEGG_Gene_Lists[[11]] <- getGenesets(org = "efu", db = "kegg")
KEGG_Gene_Lists[[12]] <- getGenesets(org = "ecj", db = "kegg")
KEGG_Gene_Lists[[13]] <- getGenesets(org = "hiw", db = "kegg")
KEGG_Gene_Lists[[14]] <- getGenesets(org = "kpn", db = "kegg")
KEGG_Gene_Lists[[15]] <- getGenesets(org = "mab", db = "kegg")
KEGG_Gene_Lists[[16]] <- getGenesets(org = "mav", db = "kegg")
KEGG_Gene_Lists[[17]] <- getGenesets(org = "pmz", db = "kegg")
KEGG_Gene_Lists[[18]] <- getGenesets(org = "pae", db = "kegg")
KEGG_Gene_Lists[[19]] <- getGenesets(org = "sao", db = "kegg")
KEGG_Gene_Lists[[20]] <- getGenesets(org = "sml", db = "kegg")
KEGG_Gene_Lists[[21]] <- getGenesets(org = "scp", db = "kegg")
KEGG_Gene_Lists[[22]] <- getGenesets(org = "spr", db = "kegg")
KEGG_Gene_Lists[[23]] <- getGenesets(org = "ssr", db = "kegg")
KEGG_Gene_Lists[[24]] <- getGenesets(org = "ssa", db = "kegg")
...
#First, merge master annotation file into Target_Prediction_Data and create KEGG_Pathway_Data
...
for (i in 1:nrow(KEGG_Pathway_Data[[1]])) {
  KEGG_Pathway_Data[[1]]$KEGG_ID[i] <- substr(KEGG_Pathway_Data[[1]]$KEGG_ID[i], 5, nchar(KEGG_Pathway_Data[[1]]$KEGG_ID[i]))
}
for (j in 1:length(KEGG_Gene_Lists[[1]])) {
    KEGG_Pathway_List[[1]][[j]] <- KEGG_Pathway_Data[[1]][KEGG_Pathway_Data[[1]]$KEGG_ID %in% KEGG_Gene_Lists[[1]][[j]],]
}
...
for (j in 1:length(KEGG_Gene_Lists[[3]])) {
    KEGG_Pathway_List[[3]][[j]] <- KEGG_Pathway_Data[[3]][KEGG_Pathway_Data[[3]]$Gene_ID %in% KEGG_Gene_Lists[[3]][[j]],]
}

for (i in 1:nrow(KEGG_Pathway_Data[[4]])) {
  KEGG_Pathway_Data[[4]]$KEGG_ID[i] <- substr(KEGG_Pathway_Data[[4]]$KEGG_ID[i], 5, nchar(KEGG_Pathway_Data[[4]]$KEGG_ID[i]))
}
for (j in 1:length(KEGG_Gene_Lists[[4]])) {
    KEGG_Pathway_List[[4]][[j]] <- KEGG_Pathway_Data[[4]][KEGG_Pathway_Data[[4]]$KEGG_ID %in% KEGG_Gene_Lists[[4]][[j]],]
}
...
for (j in 1:length(KEGG_Gene_Lists[[7]])) {
    KEGG_Pathway_List[[7]][[j]] <- KEGG_Pathway_Data[[7]][KEGG_Pathway_Data[[7]]$Gene_ID %in% KEGG_Gene_Lists[[7]][[j]],]
}
...
for (i in 1:nrow(KEGG_Pathway_Data[[10]])) {
  KEGG_Pathway_Data[[10]]$KEGG_ID[i] <- substr(KEGG_Pathway_Data[[10]]$KEGG_ID[i], 5, nchar(KEGG_Pathway_Data[[10]]$KEGG_ID[i]))
}
for (j in 1:length(KEGG_Gene_Lists[[10]])) {
    KEGG_Pathway_List[[10]][[j]] <- KEGG_Pathway_Data[[10]][KEGG_Pathway_Data[[10]]$KEGG_ID %in% KEGG_Gene_Lists[[10]][[j]],]
}
...
for (i in 1:nrow(KEGG_Pathway_Data[[12]])) {
  KEGG_Pathway_Data[[12]]$KEGG_ID[i] <- substr(KEGG_Pathway_Data[[12]]$KEGG_ID[i], 5, nchar(KEGG_Pathway_Data[[12]]$KEGG_ID[i]))
}
for (j in 1:length(KEGG_Gene_Lists[[12]])) {
    KEGG_Pathway_List[[12]][[j]] <- KEGG_Pathway_Data[[12]][KEGG_Pathway_Data[[12]]$KEGG_ID %in% KEGG_Gene_Lists[[12]][[j]],]
}
...
for (j in 1:length(KEGG_Gene_Lists[[18]])) {
    KEGG_Pathway_List[[18]][[j]] <- KEGG_Pathway_Data[[18]][KEGG_Pathway_Data[[18]]$Gene_ID %in% KEGG_Gene_Lists[[18]][[j]],]
}

for (j in 1:length(KEGG_Gene_Lists[[19]])) {
    KEGG_Pathway_List[[19]][[j]] <- KEGG_Pathway_Data[[19]][KEGG_Pathway_Data[[19]]$Gene_ID %in% KEGG_Gene_Lists[[19]][[j]],]
}
...
for (i in 1:nrow(KEGG_Pathway_Data[[21]])) {
  KEGG_Pathway_Data[[21]]$KEGG_ID[i] <- substr(KEGG_Pathway_Data[[21]]$KEGG_ID[i], 5, nchar(KEGG_Pathway_Data[[21]]$KEGG_ID[i]))
}
for (j in 1:length(KEGG_Gene_Lists[[21]])) {
    KEGG_Pathway_List[[21]][[j]] <- KEGG_Pathway_Data[[21]][KEGG_Pathway_Data[[21]]$KEGG_ID %in% KEGG_Gene_Lists[[21]][[j]],]
}

for (i in 1:nrow(KEGG_Pathway_Data[[22]])) {
  KEGG_Pathway_Data[[22]]$KEGG_ID[i] <- substr(KEGG_Pathway_Data[[22]]$KEGG_ID[i], 5, nchar(KEGG_Pathway_Data[[22]]$KEGG_ID[i]))
}
for (j in 1:length(KEGG_Gene_Lists[[22]])) {
    KEGG_Pathway_List[[22]][[j]] <- KEGG_Pathway_Data[[22]][KEGG_Pathway_Data[[22]]$KEGG_ID %in% KEGG_Gene_Lists[[22]][[j]],]
}

for (i in 1:nrow(KEGG_Pathway_Data[[23]])) {
  KEGG_Pathway_Data[[23]]$KEGG_ID[i] <- substr(KEGG_Pathway_Data[[23]]$KEGG_ID[i], 5, nchar(KEGG_Pathway_Data[[23]]$KEGG_ID[i]))
}
for (j in 1:length(KEGG_Gene_Lists[[23]])) {
    KEGG_Pathway_List[[23]][[j]] <- KEGG_Pathway_Data[[23]][KEGG_Pathway_Data[[23]]$KEGG_ID %in% KEGG_Gene_Lists[[23]][[j]],]
}

for (i in 1:nrow(KEGG_Pathway_Data[[24]])) {
  KEGG_Pathway_Data[[24]]$KEGG_ID[i] <- substr(KEGG_Pathway_Data[[24]]$KEGG_ID[i], 5, nchar(KEGG_Pathway_Data[[24]]$KEGG_ID[i]))
}
for (j in 1:length(KEGG_Gene_Lists[[24]])) {
    KEGG_Pathway_List[[24]][[j]] <- KEGG_Pathway_Data[[24]][KEGG_Pathway_Data[[24]]$KEGG_ID %in% KEGG_Gene_Lists[[24]][[j]],]
}
...
# 6. Target_Cutoff_List: Further subsets KEGG_Pathway_List based on different targeting cutoffs
```{r}
...
#Warning: This code will take a very long time (hours) to run through completely. You might want to run through the loop in segments so that you can check progress periodically
{
...
#Make sure species and pathway names are right
{
...
#Target_Cutoff_List_Copy_2_15_23 <- Target_Cutoff_List (It's a good idea to make a copy of this after you create it because it takes such a long time)
...
Target_Cutoff_List <- Target_Cutoff_List_Unique
...
#Now replace Ts with Us (Some databases with RNA sequence use T's instead of U's - but U's are more biologically relevant given that they actually appear in miRNA
...
for (a in 1:length(Target_Prediction_Data)) { 
  ...
  for(i in 1:nrow(Top_Proteins_DF)) {
    Top_Proteins_DF$`Protein Description`[i] <- substr(str_extract(rownames(Top_Proteins_DF)[i], "protein=\\s*[A-Za-z0-9 ,()-/']+\\s*"), 9, nchar(str_extract(rownames(Top_Proteins_DF)[i], "protein=\\s*[A-Za-z0-9 ,()-/']+\\s*")))
  }
  
  for (i in 1:nrow(Top_Proteins_DF)) {
    Top_Proteins_DF$Protein_ID[i] <- substr(str_extract(rownames(Top_Proteins_DF)[i], "locus_tag=\\s*[A-Za-z0-9_]+\\s*"), 11, nchar(str_extract(rownames(Top_Proteins_DF)[i], "locus_tag=\\s*[A-Za-z0-9_]+\\s*")))
  }

  Top_Proteins_DF <- Top_Proteins_DF[!duplicated(Top_Proteins_DF[, c("Protein_ID")]), ]
  rownames(Top_Proteins_DF) <- Top_Proteins_DF$Protein_ID
  Top_Proteins_DF <- Top_Proteins_DF[,-4]
...
for (i in 1:length(Energy_HM_Data)) {
  ...
  #Sometimes the miRNAs at the bottom of the list can tie so the top 10% is slightly larger for some species. We want to avoid this possibility, so have kept to the top 63 miRNAs in all cases even if we cut off one at the end of the list.
