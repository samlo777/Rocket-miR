    ...
    dashboardSidebar(
      ...
      sidebarMenu(
        ...
        menuItem("Species Filter", tabName = "Species Filter",
            ...
            div(style="text-align:center", tags$h6("the list of species in the 'Species Selection' window")),
        ...
        menuItem("Reference Publication", tabName = "Reference Publication",
            ...
            div(style="text-align:center", tags$h6("If you use our application in your own research,")),
            div(style="text-align:center", tags$h6("please cite our associated publication:")),
            
            br(),
            
            div(style="text-align:center", tags$h6("The publication will be linked here when available")),
            
            br(),
            
            div(style="text-align:center", tags$a(href="https://github.com/samlo777/Rocket-miR", 
  ...
  server <- function(input, output, session) {
    ...
    #Launch Rocket-miR Manual
    {
      showModal(modalDialog(
        ...
        br(),
        br(),
        "This application was inspired by prior work",
        tags$a(href = 'https://www.pnas.org/doi/10.1073/pnas.2105370118', "(Koeppen et al., 2021)"),
        "showing that a certain human miRNA (let-7b-5p) is capable of infiltrating cells of the common cystic fibrosis (CF) pathogen Pseudomonas aeruginosa and inhibiting protein activity - with the positive consequences of reducing antibiotic resistance and bacterial biofilm formation, two hallmarks of chronic infection.",
        br(),
        br(),
        ...
        br(),
        br(),
        "1. Summary View: What human miRNAs are predicted to target the most genes effectively in a chosen pathogen?",
        br(),
        "2. miRNA View: What biological pathways does a selected miRNA target most effectively in a chosen pathogen?",
        br(),
        "3. Pathway View: What miRNAs target a selected pathway most effectively in a chosen pathogen?",
        br(),
        "4. Compare Species: How does a selected miRNA perform across multiple species?",
        br(),
        "5. Structural Analysis: Allows you to see and compare the miRNA sequences included in the application.",
        br(),
        br(),
        "Each section comes with text explaining why it is useful and how it can be used. To get started, dismiss this user manual and select a species in the sidebar to view its predictions."
      ))
    }
        ...
        #Show miRNA View Explainer
        {
          observeEvent(input$miRNA_View_Explainer, {
            showModal(modalDialog(
              ...
              br(),
              br(),
              "Each pathway is also linked - you can follow this link to the KEGG database, where the KEGG color mapper tool has been connected via an API to highlight all of the genes that are effectively targeted on the linked pathway."
            ))
          })
        }
        ...
        #Show target cutoff explainer
        {
          observeEvent(input$Targeting_Cutoff_Explainer_1, {
            showModal(modalDialog(
              ...
              br(),
              br(),
              "The energy cutoffs (Strong: -16.98, Medium: -15.35, Weak, -13.47) in the application are set based on real data from prior experimental work (Koeppen et al., 2021).",
              br(),
              br(),
        ...
        #Show KEGG pathway image explainer
        {
          observeEvent(input$KEGG_Pathway_Image_Explainer, {
            showModal(modalDialog(
              ...
              br(),
              br(),
              "KEGG pathways are designed to apply to many different species - drawing on the principles of gene homology. However, any given species will only have a certain number of genes associated with the gene entities of the KEGG pathway - it many not have homologs for all of them.",
              br(),
              br(),
        ...
        #Show Compare Species Explainer
        {
          observeEvent(input$Compare_Species_Explainer, {
            showModal(modalDialog(
              ...
              br(),
              br(),
              "When you make these selections, the panel will show the percent of proteins effectively targeted for each species. A taller bar means that a higher percentage of proteins are effectively targeted."
            ))
          })
        }
                  ...
                  observeEvent(input$Select_Targeting_Cutoff_3, {
                    ...
                    observeEvent(input$Select_miRNA_2, {
                      ...
                      if (input$Select_miRNA_2 != "[Select a Pathway]" & input$Select_miRNA_2 != "") {
                        ...
                        {
                          X <- names(Species_Set)
                          Y <- Species_Health_Scores_Filtered_X
                          ...
                          Community_Health_Figure <- plot_ly(Data, x = ~X, y = ~Y, type = 'bar',
                            ...
                            layout(title = '', plot_bgcolor = "#e5ecf6", xaxis = list(title = 'Selected Microbial Species'), 
                                   yaxis = list(title = '% Proteins Targeted', range = list(0,100)))
